...
export const MOCK_LOGS: Log[] = [
  ...
  // ── 2026-03-19 ──────────────────────────────
  { id: "log-217", user_id: "u-002", user_name: "이민준", team: "개발팀", channel: "anthropic", model: "claude-sonnet-4", prompt: "Gridge 로그 수집 API rate limit 설계 — 테넌트별 quota 관리 방법", response: "API rate limit 및 quota 관리 설계 방법입니다...", input_tokens: 308, output_tokens: 800, cost_usd: 0.000015, latency_ms: 2010, timestamp: "2026-03-19T09:00:00Z" },
  { id: "log-218", user_id: "u-001", user_name: "강지수", team: "개발팀", channel: "anthropic", model: "claude-sonnet-4", prompt: "페이지네이션 + 날짜 필터 조합 시 URL state 동기화하는 방법", response: "URL state 동기화 구현 방법입니다...", input_tokens: 274, output_tokens: 720, cost_usd: 0.000013, latency_ms: 1780, timestamp: "2026-03-19T10:00:00Z" },
  { id: "log-219", user_id: "u-003", user_name: "박서연", team: "디자인팀", channel: "openai", model: "gpt-4o", prompt: "Gridge 빈 상태(empty state) 일러스트 방향성 — 기술적 무드보드 제안", response: "Gridge empty state 일러스트 방향성을 제안합니다...", input_tokens: 211, output_tokens: 570, cost_usd: 0.000010, latency_ms: 1400, timestamp: "2026-03-19T10:30:00Z" },
  { id: "log-220", user_id: "u-004", user_name: "최현우", team: "기획팀", channel: "gemini", model: "gemini-1.5-pro", prompt: "오늘 팀 스탠드업 — Gridge 데모 준비 현황 및 블로커 정리", response: "오늘 스탠드업 내용을 정리했습니다...", input_tokens: 186, output_tokens: 680, cost_usd: 0.000007, latency_ms: 1890, timestamp: "2026-03-19T11:00:00Z" },
  { id: "log-221", user_id: "u-005", user_name: "김태영", team: "개발팀", channel: "anthropic", model: "claude-sonnet-4", prompt: "Gridge 팀 오늘의 AI 사용 요약 — 비용 효율성 및 주요 활용 사례", response: "오늘의 AI 사용 요약 리포트입니다...", input_tokens: 228, output_tokens: 750, cost_usd: 0.000013, latency_ms: 1820, timestamp: "2026-03-19T11:30:00Z" },
  { id: "log-222", user_id: "u-001", user_name: "강지수", team: "개발팀", channel: "anthropic", model: "claude-haiku", prompt: "CSS scroll-timeline API로 스크롤 연동 애니메이션 구현하는 방법", response: "CSS scroll-timeline 애니메이션 구현 방법입니다...", input_tokens: 148, output_tokens: 350, cost_usd: 0.000002, latency_ms: 640, timestamp: "2026-03-19T14:00:00Z" },
];
